...
class GetPackageVersionFailed extends ProjectClientRelatedException
{
    /**
    ...
    {
        return (new self("Getting Package [{$project->getVersionedPackage()->getName()}] version in [{$project->getUrl()}] failed."))
            ->setProject($project);
    }
}